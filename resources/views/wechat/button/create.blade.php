...
@section('content')
    <div class="container-fluid" id="app">
        ...
        <div class="card">
            ...
            {{--循环VUE中menus属性的button   dl自定义列表  循环出的不是button而是列标题和列内容，外加背景色--}}
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check form-check-inline" >
                                                        <input class="form-check-input" type="radio" v-model="currentMenu.type"  value="click" value="option2" name="inlineRadioOptions" id="inlineRadio2" >
        ...
        require(['hdjs', 'vue'], function (hdjs, Vue) {
            new Vue({
                ...
                methods: {
                    ...
                    //删除一级菜单  删除/替换（长度为0时）：button数组开始下标为k（不包括下标）,长度为1的值，第三参数为替换值
                    delTopMenu(k){
                    ...
                    //v 指的是一级  n 二级下标  splice（数组下标，替换/删除 的长度）
                    delSubMenu(v,n){
