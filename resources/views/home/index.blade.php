                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                <a href="project-overview.html" class="avatar avatar-4by3">
                                    <img src="org/assets/img/avatars/projects/project-1.jpg" alt="..." class="avatar-img rounded">
                                </a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                <!-- Avatar -->
                                <a href="project-overview.html" class="avatar avatar-4by3">
                                    <img src="org/assets/img/avatars/projects/project-2.jpg" alt="..." class="avatar-img rounded">
                                </a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                <!-- Avatar -->
                                <a href="project-overview.html" class="avatar avatar-4by3">
                                    <img src="org/assets/img/avatars/projects/project-3.jpg" alt="..." class="avatar-img rounded">
                                </a>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                ...
                                <!-- Avatar -->
                                <a href="project-overview.html" class="avatar avatar-4by3">
                                    <img src="org/assets/img/avatars/projects/project-5.jpg" alt="..." class="avatar-img rounded">
                                </a>
                                ...
                                <td class="text-right">
                                    <div class="avatar-group">
                                        <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Dianna Smiley">
                                            <img src="org/assets/img/avatars/profiles/avatar-1.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                        </a>
                                        <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Ab Hadley">
                                            <img src="org/assets/img/avatars/profiles/avatar-2.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                        </a>
                                        <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Adolfo Hess">
                                            <img src="org/assets/img/avatars/profiles/avatar-3.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                        </a>
                                        <a href="profile-posts.html" class="avatar avatar-xs" data-toggle="tooltip" title="" data-original-title="Daniela Dewitt">
                                            <img src="org/assets/img/avatars/profiles/avatar-4.jpg" class="avatar-img rounded-circle border border-white" alt="...">
                                        </a>
                                    </div>
                                </td>
                                <td class="text-right">
