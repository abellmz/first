                ...
                <div class="container-fluid">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <ul class="nav nav-tabs nav-overflow header-tabs">
                                    <li class="nav-item">
                                        <a href="{{route('member.my_collection',[$user,'type'=>'article'])}}" class="nav-link active">
                                            文章
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('member.my_collection',[$user,'type'=>'comment'])}}" class="nav-link">
                                            评论
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-auto">
                                                        ...
                                                        <a href="" class="avatar avatar-sm">
                                                            {{--这条数据  关联的文章 再关联user  取出icon--}}
                                                            <img src="{{$collection->belongsModel->user->icon}}" alt="..." class="avatar-img rounded">
                                                        </a>
                                                    ...
                                                    <div class="col ml--2">
                                                        ...
                                                        <h4 class="card-title mb-1 name">
                                                            <a href="http://laravel-cms.edu/home/article/1">
                                                                {{$collection->belongsModel->title}}</a>
                                                        </h4>

                                                        <p class="card-text small mb-1">
                                                            <a href="http://laravel-cms.edu/member/user/29" class="text-secondary mr-2">
                                                                <i class="fa fa-user-circle" aria-hidden="true"></i> {{$collection->belongsModel->user->name}}
                                                            </a>

                                                            <i class="fa fa-clock-o" aria-hidden="true"></i> {{$collection->belongsModel->created_at->diffForHumans()}}

                                                            <a href="http://www.houdunren.com/edu/topics_1.html" class="text-secondary ml-2">
                                                                <i class="fa fa-folder-o" aria-hidden="true"></i>
                                                                {{$collection->belongsModel->category->title}}
                                                            </a>
                                                        </p>
                            ...
                            {{--                这好像是多态分页的用法？--}}
                            {{$collectionData->appends(['type'=>Request::query('type')])->links()}}
                        </div>
                    </div> <!-- / .row -->
                </div>
            </div>
